                ...
                <div className="card border-0 w">
                  <div className="card-body forgot dark">
                    ...
                    <p className="card-text">
                      Como usuario nuevo, debes asignar una contraseña, escribe tu usuario correo electronico o numero celular según tu caso
                      y asigna la contraseña, enviaremos un código de validación y podrás iniciar tu acceso.
                    </p>
                ...
                <div className="card w">
                  <div className="card-body forgot">
                    <div className={this.state.valid ? "tab d-none" : "tab"}>
                      <div className="row">
                        <h4 className="col-12 text-center p-1">Asignar contraseña</h4>
                      </div>
                    ...
                    <div className={this.state.valid ? "tab" : "tab d-none"}>
                      <div className="row">
                        <h4 className="col-12 text-center p-1">Iniciar sessión</h4>
                      </div>
